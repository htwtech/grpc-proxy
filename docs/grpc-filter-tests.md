...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"accounts":{"filter":{"account":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ","9vruaxeU4HEnj8czkpdyYeScnerqoEAjpuGBHh7kNKbV"]}}}' $HOST geyser.Geyser/Subscribe
```
...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"accounts":{"filter":{"account":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ","9vruaxeU4HEnj8czkpdyYeScnerqoEAjpuGBHh7kNKbV","EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v","Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB","So11111111111111111111111111111111111111112"]}}}' $HOST geyser.Geyser/Subscribe
```
...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"accounts":{"filter":{"account":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"]}},"accounts_data_slice":[{"offset":0,"length":32},{"offset":32,"length":32},{"offset":64,"length":32},{"offset":96,"length":32}]}' $HOST geyser.Geyser/Subscribe
```
...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"transactions":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"]}}}' $HOST geyser.Geyser/Subscribe
```

### transactions: account_exclude
```bash
grpcurl -plaintext -proto geyser.proto -d '{"transactions":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"],"account_exclude":["Vote111111111111111111111111111111111111111"]}}}' $HOST geyser.Geyser/Subscribe
```

### transactions: account_required
```bash
grpcurl -plaintext -proto geyser.proto -d '{"transactions":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"],"account_required":["EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"]}}}' $HOST geyser.Geyser/Subscribe
```
...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"transactions":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ","9vruaxeU4HEnj8czkpdyYeScnerqoEAjpuGBHh7kNKbV","EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v","Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB","So11111111111111111111111111111111111111112"]}}}' $HOST geyser.Geyser/Subscribe
```
...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"transactions_status":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"]}}}' $HOST geyser.Geyser/Subscribe
```

### transactions_status: account_exclude
```bash
grpcurl -plaintext -proto geyser.proto -d '{"transactions_status":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"],"account_exclude":["Vote111111111111111111111111111111111111111"]}}}' $HOST geyser.Geyser/Subscribe
```

### transactions_status: account_required
```bash
grpcurl -plaintext -proto geyser.proto -d '{"transactions_status":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"],"account_required":["EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"]}}}' $HOST geyser.Geyser/Subscribe
```
...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"blocks":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"]}}}' $HOST geyser.Geyser/Subscribe
```

### blocks: include_transactions = true (should pass if allowed)
```bash
grpcurl -plaintext -proto geyser.proto -d '{"blocks":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"],"include_transactions":true}}}' $HOST geyser.Geyser/Subscribe
```

### blocks: include_accounts = true (should be rejected if not allowed)
```bash
grpcurl -plaintext -proto geyser.proto -d '{"blocks":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"],"include_accounts":true}}}' $HOST geyser.Geyser/Subscribe
```

### blocks: include_entries = true (should be rejected if not allowed)
```bash
grpcurl -plaintext -proto geyser.proto -d '{"blocks":{"filter":{"account_include":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"],"include_entries":true}}}' $HOST geyser.Geyser/Subscribe
```
...
```bash
for i in $(seq 1 6); do grpcurl -plaintext -proto geyser.proto -d '{"accounts":{"filter":{"account":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"]}}}' $HOST geyser.Geyser/Subscribe & done; wait
```
...
```bash
grpcurl -plaintext -proto geyser.proto -d '{"accounts":{"filter":{"account":["J6wg7WSJcvZeBpbwgXAkVyCQS2R2TxdEbcsNCzdqxzYJ"]}}}' $HOST geyser.Geyser/Subscribe
```
